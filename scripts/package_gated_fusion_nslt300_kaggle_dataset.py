...
try:
    ...
    raise SystemExit(
        ...
        ".\\.venv-rtmw310\\Scripts\\python.exe scripts/package_gated_fusion_nslt300_kaggle_dataset.py ..."
    ) from exc
...
FUSION_CONFIG_PATH = Path("configs/train/gated_feature_fusion_nslt300.yaml")
REQUIREMENT_SCRIPT_PATH = Path("scripts/check_gated_fusion_nslt300_packaging_requirements.py")
REFERENCE_PATHS = [
    "scripts/package_gated_fusion_nslt100_kaggle_dataset.py",
    "scripts/check_gated_fusion_setup.py",
    "configs/train/gated_feature_fusion_nslt100.yaml",
...
def create_readme(package_name: str) -> str:
    ...
    return textwrap.dedent(
        ...
        Validation:
        ```bash
        python scripts/evaluate_gated_fusion.py \\
          --config {kaggle_root}/configs/gated_feature_fusion_nslt300_kaggle.yaml \\
