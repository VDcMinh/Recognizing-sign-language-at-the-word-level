...
def build_report(
    ...
    lines.extend(
        [
            ...
            "## Output Size",
            "",
            f"- crops/{subset}: `{_format_size(size_crops)}`",
            f"- tensors/{subset}: `{_format_size(size_tensors)}`",
            f"- previews/{subset}: `{_format_size(size_previews)}`",
            f"- manifests: `{_format_size(size_manifests)}`",
            f"- reports: `{_format_size(size_reports)}`",
            f"- total regions output size for {subset}: `{_format_size(total_output_size)}`",
            "",
            "## Output Paths",
            "",
